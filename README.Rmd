...
and `1/e` is a valid p-value. Interpretation: If we bet 1 dollar against the
hypothesis that `F2` is probabilistically calibrated, then after n = 730 days,
we would have turned this 1 dollar into 65'291 dollars. For `F1`, we would
remain with only 0.0033 dollars...
